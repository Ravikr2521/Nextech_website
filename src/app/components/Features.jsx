...
const Features = () => {
  ...
  return (
    ...
    //       return (
    //         <div
    //           className="border border-gray-200 relative dark:border-gray-600 shadow-lg hover:shadow-xl transition-all rounded-lg  flex flex-col items-center justify-between transform hover:scale-105 duration-300"
    //           key={index}
    //         >
    //           <img
    //             src={item.image}
