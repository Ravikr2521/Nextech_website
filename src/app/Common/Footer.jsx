      ...
      <footer className=" dark:bg-gray-800">
        ...
        <div className="max-w-screen-xl p-4 py-6 mx-auto lg:py-6   md:p-8 lg:p-6">
          <div className="text-center">
            ...
            <div className="flex justify-center gap-2 items-center  text-gray-800">
              <FaLocationDot className="" />
              1601, 16th Floor, World Trade Tower, Plot No. C-001, Sector 16,
              Noida, Uttar Pradesh 201301
            </div>
            <span className="block text-sm text-center text-gray-500 dark:text-gray-400 mt-5 lg:mt-10">
              © 2023 LEADSNEXTECH INDIA PVT. LTD. | ALL RIGHTS RESERVED .
            </span>
